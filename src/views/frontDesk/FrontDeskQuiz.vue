  ...
  setup() {
    const questions = reactive({
      questions: [
        ...
        {
          question: '今天上班完很累，回家想擦個精油放鬆，以下四罐精油會選擇哪一罐?',
          answers: [
        ...
        {
          question: '假如你到商場里買衣服，以下三種顏色的衣服，哪一種是你最不喜歡的？',
          answers: [
            { answer: '黑色洋裝', score: 1 },
            { answer: '藍色外套', score: 3 },
            { answer: '紅色風衣', score: 4 },
  ...
  <div class="container" style="min-height: calc(100vh - 112px)">
    <div class="py-5">
      ...
      >
        ...
        <p class="text-secondary">幫你找出適合的能量石</p>
        <div
          class="question"
        ...
        <div v-else>
          <div class="container">
            ...
            <div class="row">
              ...
              v-for="(item) in filterProducts.obj" :key="item.id">
            <div class="img-card">
